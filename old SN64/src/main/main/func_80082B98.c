...
void func_80082B98(Unk *arg0, Unk *arg1) {
    ...
    temp_v0 = func_8007FD48(0, 0, temp_s7, 1, 0x1C);
    sp5C = temp_v0;
    func_80082E98(temp_v0);
    arg0->unk38 = sp5C;
    arg0->unk34 = func_8007FD48(0, 0, temp_s7, 1, 0x4C);
    arg0->unk40 = 1;
    func_80082F30(arg0->unk34, func_8007FD48(0, 0, temp_s7, arg1->unk4, 4), arg1->unk4);
    arg0->unk30 = func_8007FD48(0, 0, temp_s7, 1, 0x20);
    func_80082EDC(arg0->unk30, func_8007FD48(0, 0, temp_s7, arg1->unk4, 4), arg1->unk4);
    if (arg1->unk1C != 0) {
        func_800865F8(arg0, 0, arg1, temp_s7);
    } else {
        func_80084F18(arg0->unk30, 2, arg0->unk34);
    }
    arg0->unk4 = 0;
    arg0->unk8 = 0;
    arg0->unk14 = 0;
    ...
    arg0->unkC = 0;
    arg0->unk10 = 0;
    temp_v0_2 = func_8007FD48(0, 0, temp_s7, arg1->unk4, 0xDC);
    var_s4 = 0;
    var_s0 = temp_v0_2;
    if (arg1->unk4 > 0) {
    ...
    temp_v0_3 = func_8007FD48(0, 0, temp_s7, arg1->unk8, 0x1C);
    arg0->unk2C = 0;
    var_v1 = temp_v0_3;
    if (arg1->unk8 > 0) {
        do {
