...
void func_80060834(s32 arg0) {
    func_8007BCD8(&D_80174730, &D_8017C808, 0x20);
    D_80181E40.unk0 = arg0;
    D_80181E40.unk4 = &D_80174730;
    func_8007BD08(&D_80178458, 5, &func_800602A0, &D_80181E40, &D_80178450, 8);
    func_8007D0E8(&D_80178458);
}
...
void func_800608C8(s32 arg1, s8 arg2, s8 arg3, u16 arg4, u16 arg5, u16 arg6) {
    ...
    temp_v0 = (D_80092B70 * 0x10) + D_801821E8;
    temp_v0->unk0 = arg1;
    temp_v0->unkA = arg2;
    ((D_80092B70 * 0x10) + D_801821E8)->unkB = arg3;
    temp_v0_2 = (D_80092B70 * 0x10) + D_801821E8;
    temp_v0_2->unk4 = arg4;
    temp_v0_2->unk6 = arg5;
    temp_v0_2->unk8 = arg6;
}
