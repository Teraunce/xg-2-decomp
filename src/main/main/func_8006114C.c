    ...
    if (gLineVtxIdx != 0) {
        ...
        *arg0 = temp_v0 + 8;
        ...
        if (gLineTexPtr != 0) {
            var_t0 = 0;
            do {
                temp_v1 = var_t0 + gLineTexBase;
                if (temp_v1->unk0 != 0) {
                    temp_v1_2 = temp_v1->unkA;
                    if (temp_v1_2 == 4) {
                        temp_a0 = *arg0;
                        *arg0 = temp_a0 + 8;
                        temp_a1 = var_t0 + gLineTexBase;
                        var_v1 = 0xFD500000;
                        if (temp_a1->unkB != 0) {
                            var_v1 = 0xFD900000;
                        }
                        ...
                        *arg0 = temp_a0_2 + 8;
                        var_v1_2 = 0xF5500000;
                        if ((void *)((Unk *)(var_t0 + gLineTexBase))->unkB != 0) {
                            var_v1_2 = 0xF5900000;
                        }
                        ...
                        *arg0 = temp_v0_5 + 8;
                        ...
                        temp_a1_3 = *arg0;
                        *arg0 = temp_a1_3 + 8;
                        temp_v1_3 = var_t0 + gLineTexBase;
                        var_v0_2 = 0xF5400000;
                        if (temp_v1_3->unkB != 0) {
                            var_v0_2 = 0xF5800000;
                        }
                        temp_a1_3->unk0 = (s32) (((((s32) (((u16) temp_v1_3->unk4 >> 1) + 7) >> 3) & 0x1FF) << 9) | var_v0_2);
                        var_v0_3 = ((Unk *)(var_t0 + gLineTexBase))->unk8 & 0xF;
                        goto block_50;
                    }
                    if (temp_v1_2 != 8) {
                        if (temp_v1_2 == 0x10) {
                            ...
                            *arg0 = temp_v0_6 + 8;
                            ...
                            temp_v0_6->unk4 = (s32) *(var_t0 + gLineTexBase);
                            temp_v0_7 = *arg0;
                            *arg0 = temp_v0_7 + 8;
                            ...
                            *arg0 = temp_v0_9 + 8;
                            ...
                            temp_a0_4 = ((Unk *)(var_t0 + gLineTexBase))->unk4;
                            var_v0_4 = temp_a0_4;
                            if ((s32) temp_a0_4 < 0) {
                            ...
                            temp_v0_11 = var_t0 + gLineTexBase;
                        ...
                        *arg0 = temp_v0_16 + 8;
                        ...
                        temp_v0_17 = var_t0 + gLineTexBase;
...
block_50:
                        ...
                        *arg0 = temp_v0_19 + 8;
                        ...
                        temp_v0_20 = var_t0 + gLineTexBase;
