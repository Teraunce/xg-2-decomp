...
void trackNodeSearchNearest(f32 *arg0, s32 *arg1, f32 arg2, f32 arg3, f32 arg4, s32 arg5) {
    ...
    temp_s1 = ((Unk *)gCurRenderNode->unk8)->unk38;
    var_s0 = arg5;
    *(((s32) (((Unk *)((char *)(s32)temp_s1 + arg5 * 0x38))->unk16 & 0xF800) >> 0xB) + &gEntityVisited) = 1;
    var_v0 = var_s0 * 8;
loop_1:
    ...
    if (temp_v1 != var_s0) {
        var_v0_2 = var_s0 * 8;
        if (*(((s32) (((Unk *)((char *)(s32)temp_s1 + temp_v1 * 0x38))->unk16 & 0xF800) >> 0xB) + &gEntityVisited) == 0) {
...
block_4:
    ...
    if (temp_a0_2->unk16 & (gEntityFlagMask * 4)) {
