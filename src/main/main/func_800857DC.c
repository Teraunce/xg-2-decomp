...
f32 audioTriOsc(Unk*, s32);                     /* extern */
char *audioLoopDmaCmd(f32, s32, void *, s32, s32, s32, s32); /* extern */

char *audioTriOscCmd(Unk *arg0, Unk *arg1, s32 arg2, s32 arg3, s32 arg4) {
    char *sp5C;
    f32 sp44;
    s32 sp38;
    char *sp30;
    ...
    if (arg1->unk24 != 0) {
        ...
        temp_fv1 = (f32) (1.0 - (f64) ((f32) (s32) ((audioTriOsc(arg1, arg3) / (f32) sp38) * 32768.0f) / 32768.0f));
        sp44 = temp_fv1;
        temp_v0 = arg1->unk24;
        ...
        temp_t3 = temp_t8 * 2;
        sp28 = temp_t3;
        temp_v0_2 = audioLoopDmaCmd(temp_fa0, 0x47000000, arg0, temp_t0 - temp_t3, 0x280, temp_ft4 + temp_t8, arg4);
        temp_t6 = temp_v0_2 + 8;
        ...
        var_v1 = audioLoopDmaCmd((f32)(s32) arg0, arg0->unk18 + (arg1->unk4 * -2), (void *)(s32) arg2, arg3, arg4, 0, 0);
    }
    return var_v1;
}
