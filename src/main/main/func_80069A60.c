...
extern f32 gCamProjScale;
extern f32 gEntityRenderParam0;
extern f32 gEntityRenderParam1;
extern f32 gEntityRenderParam2;
extern f32 gEntityScaleF;
extern f32 gEntityRenderParam3;
extern f32 gEntityRenderParam4;
extern f32 gEntityClampA;
extern f32 gEntityRenderParam5;
extern f32 gEntityRenderParam6;
extern f32 gEntityRenderParam7;
extern f32 gEntityRenderParam8;
extern f32 gEntityRenderParam9;
    ...
    if (temp_a1_2->unk0 == 0) {
        ...
        if (temp_v1_2 != 0) {
            ...
            if (temp_v1_2 != 1) {
                ...
                var_ft1 -= gEntityRenderParam1;
                var_ft2 += gEntityRenderParam2;
                goto block_6;
            }
        } else {
            var_ft1 -= gEntityRenderParam0;
block_6:
            var_s0 = &gRenderIdx;
            var_s2 = &gRenderBase;
        }
        guEulerScaleL(*var_s2 + ((*var_s0 << 7) + 0x80) + (gPlayerList << 6), gEntityScaleF, gEntityScaleF, 0, gEntityRenderParam3, (temp_a1_2->unk34 - temp_a1_2->unk40) * gCamProjScale, var_ft1, var_ft2);
        temp_v1_3 = *var_s2;
        temp_t2 = gDLPtr + 8;
        temp_a1_3 = *var_s0 << 7;
        gDLPtr->unk0 = 0xDA380003;
        temp_a0 = gPlayerList << 6;
        gDLPtr->unk4 = (void *) (temp_v1_3 + temp_a1_3 + temp_a0);
        gDLPtr = temp_t2;
        gDLPtr = temp_t2 + 8;
        gDLPtr = temp_t2 + 0x10;
        gDLPtr->unk8 = 0xDA380001;
        ...
        if (arg2 != 0) {
            if (arg2 < 0xFF) {
                ...
                gDLPtr = temp_t2 + 0x18;
                gDLPtr = temp_t2 + 0x20;
                var_t0 = ((Unk*)(((Unk*)((char*)&gRaceCtx + arg7 * 4))->unk16F8))->unk8;
...
block_11:
        ...
        temp_a3->unkC = (void *) gLineVtxBase;
        gLineVtxBase->unk0 = 0xE7000000;
        gLineVtxBase->unk4 = 0;
        gLineVtxBase += 8;
        if (arg0->unk54 >= 0xD) {
        ...
        if (!(gEntityClampA <= temp_fv0)) {
            ...
            var_v1_2 = (s32) (temp_fv0 - gEntityClampA) | 0x80000000;
        }
        temp_a3_2->unk0 = (s32) (((var_v1_2 & 0xFFF) << 0xC) | 0xF2000000);
        temp_a3_2->unk4 = 0;
        temp_t3 = gLineVtxBase + 8;
        gLineVtxBase->unk0 = 0xDF000000;
        gLineVtxBase->unk4 = 0;
        gDLPtr->unk0 = 0xDB060018;
        gDLPtr->unk4 = temp_t3;
        gLineVtxBase->unk8 = 0xE7000000;
        temp_t3->unk4 = 0;
        ...
        if (((Unk *)arg0->unkC)->unk2C != 0) {
            ...
            gLineVtxBase = temp_t3 + 0x18;
            gLineVtxBase = temp_t3 + 0x20;
            gLineVtxBase = temp_t3 + 0x28;
            gLineVtxBase = temp_t3 + 0x30;
            var_fv1 = gEntityRenderParam5;
            temp_t3->unk8 = 0xFD100000;
            gLineVtxBase = temp_t3 + 0x38;
            ...
            if (gEntityRenderParam7 < arg5) {
                var_t5 = 0x200;
                var_t6 = 0;
                var_fv1 = gEntityRenderParam8;
            }
            if (gEntityRenderParam9 < arg5) {
                var_t5 = 0x300;
                var_t6 = 1;
                var_fv1 = gEntityRenderParamA;
            }
            gLineVtxBase = temp_t3 + 0x40;
            gLineVtxBase = temp_t3 + 0x48;
            gLineVtxBase = temp_t3 + 0x50;
            gLineVtxBase = temp_t3 + 0x58;
            gLineVtxBase = temp_t3 + 0x60;
            temp_t3->unk38 = 0xFD100000;
            temp_a2 = temp_t3 + 0x70;
            gLineVtxBase = temp_t3 + 0x68;
            gLineVtxBase = temp_a2;
            gLineVtxBase = temp_t3 + 0x78;
            ...
            if (!(gEntityClampB <= temp_fv0_2)) {
                ...
                var_v1_3 = (s32) (temp_fv0_2 - gEntityClampB) | 0x80000000;
            }
            temp_t3->unk70 = (s32) (((var_v1_3 & 0xFFF) << 0xC) | 0xF2000000);
            temp_a2->unk4 = 0x01000000;
            temp_v1_5 = gLineVtxBase;
            gLineVtxBase += 8;
            temp_v1_5->unk0 = 0xFC113280;
            temp_v1_5->unk4 = -8;
        }
        temp_a0_2 = gLineVtxBase;
        temp_t0 = gLineVtxBase + 8;
        temp_a0_2->unk0 = 0xDF000000;
        gLineVtxBase = temp_t0;
        gLineVtxBase = temp_t0 + 8;
        temp_a0_2->unk4 = 0;
        ...
        gLineVtxBase = var_v1_4;
        temp_t0->unkC = var_v0_2;
        temp_a0_3 = gLineVtxBase;
        gLineVtxBase += 8;
...
block_38:
        ...
        if ((arg2 != 0) && (arg2 != 0xFF)) {
            ...
            case 0:
                ...
                temp_a0_4 = gRenderIdx << 7;
                temp_a2_2 = gPlayerList << 6;
                temp_t1->unk14 = (s32) (gRenderBase + temp_a0_4 + temp_a2_2);
                gDLPtr = temp_t1 + 0x18;
                gDLPtr = temp_t1 + 0x20;
...
block_53:
            ...
            case 1:
                ...
                temp_t1->unk14 = (s32) (gRenderBase + temp_a0_5 + var_a2);
                gDLPtr = temp_t1 + 0x18;
                gDLPtr = temp_t1 + 0x20;
            ...
            if (var_s6 != 1) {
                if (var_s6 < 2) {
                    ...
                    if (var_s6 != 0) {
                        ...
                        temp_t1_2->unk14 = (s32) (gRenderBase + temp_a0_7 + temp_a2_3);
                    ...
                    temp_t1_2->unk14 = (s32) (gRenderBase + temp_a0_8 + var_a2_3);
                    gDLPtr = temp_t1_2 + 0x18;
                    gDLPtr = temp_t1_2 + 0x20;
