...
s32 contPakWriteNoteEntry(Unk *, u8 *, s32, Unk *);  /* func_8008A898 */
...
s32 contPakWriteNote(Unk *arg0, s32 arg1, u8 arg2, s32 arg3, s32 arg4, char *arg5) {
    ...
    sp154 = osContPakRead(arg0->unk4, arg0->unk8, arg0->unk5C + arg1, &sp134);
    if (sp154 != 0) {
        return sp154;
    }
    ...
    if (sp2C >= 8) {
loop_29:
        sp154 = contPakWriteNoteEntry(arg0, &sp23, &sp34, &sp30);
        if (sp154 != 0) {
            return sp154;
        }
        sp2C -= 8;
...
block_37:
        ...
        sp20 = temp_t3_2;
        if (arg2 == 0) {
            var_v0 = osContPakRead(arg0->unk4, arg0->unk8, temp_t3_2 & 0xFFFF, sp24);
        } else {
            var_v0 = osContPakWrite(arg0->unk4, arg0->unk8, sp20, sp24, 0);
        }
        sp154 = var_v0;
        if (sp154 != 0) {
            return sp154;
...
block_46:
    if ((arg2 == 1) && !(sp13C & 2)) {
        ...
        sp154 = osContPakWrite(arg0->unk4, arg0->unk8, arg0->unk5C + arg1, &sp134, 0);
        if (sp154 != 0) {
            return sp154;
        }
        goto block_52;
