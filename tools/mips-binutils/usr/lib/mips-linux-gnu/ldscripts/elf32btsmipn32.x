...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/usr/local/lib/mips-linux-gnu"); SEARCH_DIR("=/lib/mips-linux-gnu"); SEARCH_DIR("=/usr/lib/mips-linux-gnu"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib"); SEARCH_DIR("=/usr/mips-linux-gnu/lib32"); SEARCH_DIR("=/usr/mips-linux-gnu/lib");
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x10000000));
  . = SEGMENT_START("text-segment", 0x10000000) + SIZEOF_HEADERS;
