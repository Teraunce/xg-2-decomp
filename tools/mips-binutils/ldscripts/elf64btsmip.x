...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/usr/local/lib/mips64-linux-gnuabi64"); SEARCH_DIR("=/lib/mips64-linux-gnuabi64"); SEARCH_DIR("=/usr/lib/mips64-linux-gnuabi64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib"); SEARCH_DIR("=/usr/mips-linux-gnu/lib64"); SEARCH_DIR("=/usr/mips-linux-gnu/lib");
SECTIONS
{
